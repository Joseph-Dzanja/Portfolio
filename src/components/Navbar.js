...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-black/30 shadow-none sm:px-18 px-6 py-4 flex items-center justify-between h-[80px]">
      {/* Profile Picture */}
      ...
      {isOpen && (
        <div className="absolute top-full right-4 mt-2 w-48 bg-black/80 text-white p-4 rounded-lg shadow-lg">
          <ul className="space-y-2">
            ...
            <li><a href="#skills" className="block hover:underline">Skills</a></li>
            <li><a href="#experience" className="block hover:underline">Experience</a></li>
            <li><a href="#projects" className="block hover:underline">Projects</a></li>
